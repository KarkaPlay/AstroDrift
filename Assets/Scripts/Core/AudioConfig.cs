...
public class AudioConfig : ScriptableObject
{
    ...
    [Header("Пользовательские каналы (0–1) — дефолт, если игрок ещё не двигал слайдер")]
    [Tooltip("Канал «звуки игры» (SFX). Рантайм-значение живёт в AudioManager и сохраняется отдельно; " +
             "это поле — только дефолт первого запуска. Слайдер настроек НЕ пишет сюда.")]
    public float sfxVolume = 1f;

    [Tooltip("Канал «музыка». Музыкального трека в игре пока нет — значение только хранится и сохраняется.")]
